                        ...
                        <div class="search_form_container">
                            <form action="#" class="search_form" id="search_form">
                                <div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
                                    ...
                                    <input class="search_input" type="text" name="titLibro" id="titLibro" style="width: 2000px; margin-left: 20px" required/>
                                </div>
                                <br>
                                <div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
                                    <label class="col-form-label-sm text-white" for="editLibro" style="font-size: 20px">EDITORIAL:</label>
                                    <input class="search_input" type="text" name="editLibro" id="editLibro" style="width: 2000px; margin-left: 20px"  required/>
                                </div>
                                <br>
                                <div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
                                ...
                                <div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
                                    ...
                                    <input class="search_input" type="date" name="fechaPublLibro" id="fechaPublLibro" max="<?php echo (date('Y-m-d')); ?>" style="width: 780px; margin-left: 20px" required/>
                                    <button class="search_button" type="submit" name="boton" formaction="insertarLibro.php" style="width: 400px; margin-left: 20px">Enviar</button>
                                </div>
                            </form>
                        </div>
                    </div>
